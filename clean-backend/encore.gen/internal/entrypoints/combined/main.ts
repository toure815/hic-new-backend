...
import { completeOnboarding as onboarding_completeOnboardingImpl4 } from "../../../../onboarding/complete_onboarding";
import { getDraft as onboarding_getDraftImpl5 } from "../../../../onboarding/get_draft";
import { saveDraft as onboarding_saveDraftImpl6 } from "../../../../onboarding/save_draft";
import { uploadDocument as onboarding_uploadDocumentImpl7 } from "../../../../onboarding/upload_document";
...
const handlers: Handler[] = [
    ...
    },
    {
        apiRoute: {
            ...
            handler:           onboarding_completeOnboardingImpl4,
            raw:               false,
            streamingRequest:  false,
            streamingResponse: false,
        },
    ...
    },
    {
        apiRoute: {
            service:           "onboarding",
            name:              "getDraft",
            handler:           onboarding_getDraftImpl5,
            raw:               false,
            streamingRequest:  false,
            streamingResponse: false,
        },
    ...
    },
    {
        apiRoute: {
            service:           "onboarding",
            name:              "saveDraft",
            handler:           onboarding_saveDraftImpl6,
            raw:               false,
            streamingRequest:  false,
            streamingResponse: false,
        },
    ...
    },
    {
        apiRoute: {
            service:           "onboarding",
            name:              "uploadDocument",
            handler:           onboarding_uploadDocumentImpl7,
            raw:               false,
            streamingRequest:  false,
            streamingResponse: false,
        },
